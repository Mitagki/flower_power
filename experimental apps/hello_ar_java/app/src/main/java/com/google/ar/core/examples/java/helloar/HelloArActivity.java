...
public class HelloArActivity extends AppCompatActivity implements SampleRender.Renderer {
  ...
  public void onDrawFrame(SampleRender render) {
    ...
    if (distance == null) {
      ...
      messageSnackbarHelper.showMessage(this, distance + " meters");
    }
  ...
  private void handleTap(Frame frame, Camera camera) {
    //messageSnackbarHelper.showMessage(this, "lekooo");
    //distance = "Hello";
    ...
    if (tap != null && camera.getTrackingState() == TrackingState.TRACKING) {
      ...
      for (HitResult hit : hitResultList) {
        distance = String.valueOf(hit.getDistance());
        ...
        if ((trackable instanceof Plane
          ...
          //messageSnackbarHelper.showMessage(this, String.valueOf(hit.getDistance()));
          break;
        }
