                                            ...
                                            child: Padding(
                                              ...
                                              child: AutoSizeText(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'pq9ujt04' /* Use the camera of your device ... */,
                                                ),
                                                style:
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: AutoSizeText(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'ivstcsdt' /* Upload a photo of wildflowers ... */,
                                                  ),
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'HOME_homeCard_Appointments_ON_TAP');
                              logFirebaseEvent(
                                  'homeCard_Appointments_navigate_to');
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => MedalsWidget(),
                                ),
                              );
                            },
                            child: Material(
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: AutoSizeText(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '897teu7b' /* Contribute to wildflower biodi... */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodySmall
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: AutoSizeText(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '4bqu2vvj' /* Compete in weekly updated chal... */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodySmall
