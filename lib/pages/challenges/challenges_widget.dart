              ...
              child: Row(
                ...
                children: [
                  InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent('CHALLENGES_PAGE_Icon_74i0coj3_ON_TAP');
                                          ...
                                          children: [
                                            ClipRRect(
                                              borderRadius:
                                                  BorderRadius.circular(8.0),
                                              child: Image.asset(
                                                'assets/images/Agrostemma_githago_120605.jpg',
                                                width: 130.0,
                                                height: 130.0,
                                                fit: BoxFit.contain,
                                              ),
                                                    ...
                                                    Expanded(
                                                      child: AutoSizeText(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'aczu5g4d' /* Monthly Eindhoven Challenge */,
                                                        ),
                                                        maxLines: 2,
                                                        style:
                                                            FlutterFlowTheme.of(
