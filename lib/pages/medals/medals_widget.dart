...
class _MedalsWidgetState extends State<MedalsWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MedalsModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'medals'});
              ...
              child: Row(
                ...
                children: [
                  InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent('MEDALS_PAGE_Icon_vfa4vopb_ON_TAP');
                                          ...
                                          children: [
                                            ClipRRect(
                                              borderRadius:
                                                  BorderRadius.circular(100.0),
                                              child: Image.asset(
                                                'assets/images/gold-medal-28.png',
                                                width: 130.0,
                                                height: 130.0,
                                                fit: BoxFit.contain,
                                              ),
