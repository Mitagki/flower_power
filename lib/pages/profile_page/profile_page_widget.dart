                              ...
                              children: [
                                Expanded(
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'PROFILE_Container_guves99i_ON_TAP');
                                      logFirebaseEvent('Container_navigate_to');
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) =>
                                              ObservationDetailsWidget(),
                                        ),
                                      );
                                    },
                                    child: Container(
