                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'kfwg0uer' /* Edit the fields below in order... */,
                                  ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'ckfo4lke' /* Emails will be sent to: */,
                            ),
                        ...
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            ...
                            options: [
                              FFLocalizations.of(context).getText(
                                'mfbe8ytp' /* Type of Appointment */,
                              ),
                              FFLocalizations.of(context).getText(
                                'jjmdih9x' /* Doctors Visit */,
                              ),
                              FFLocalizations.of(context).getText(
                                'iuozni7f' /* Routine Checkup */,
                              ),
                              FFLocalizations.of(context).getText(
                                'rnnep5hs' /* Scan/Update */,
                              )
                            ],
                            onChanged: (val) =>
