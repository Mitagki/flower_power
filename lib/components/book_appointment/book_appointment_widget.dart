                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'gg8vixuz' /* Fill out the information below... */,
                                      ),
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'xwf0myo9' /* Emails will be sent to: */,
                                ),
                            ...
                            Padding(
                              ...
                              child: FlutterFlowDropDown<String>(
                                ...
                                options: [
                                  FFLocalizations.of(context).getText(
                                    'mi4aakm9' /* Doctors Visit */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'ww3eexto' /* Routine Checkup */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'ohe3on5k' /* Scan/Update */,
                                  )
                                ],
                                onChanged: (val) =>
