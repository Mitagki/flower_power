                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '2w7mi07k' /* Fill out the information below... */,
                            ),
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown<String>(
                      ...
                      options: [
                        FFLocalizations.of(context).getText(
                          'z8eamycr' /* Doctors Visit */,
                        ),
                        FFLocalizations.of(context).getText(
                          'pc2mn3pg' /* Routine Checkup */,
                        ),
                        FFLocalizations.of(context).getText(
                          'beco5gtl' /* Scan/Update */,
                        )
                      ],
                      onChanged: (val) =>
